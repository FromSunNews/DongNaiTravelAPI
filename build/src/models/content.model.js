...
var contentCollectionName = 'content';
var contentCollectionSchema = _joi["default"].object({
  content_id: _joi["default"].string()["default"](null),
  // whole is content
  plainText: _joi["default"].object()["default"]({}),
  // text-to-speech
  plainTextBase64: _joi["default"].object()["default"]({}),
  // For markdown
  plainTextMarkFormat: _joi["default"].object()["default"]({}),
...
var INVALID_UPDATE_FILEDS = ['_id', 'content_id', 'createdAt'];
  ...
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(data) {
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return contentCollectionSchema.validateAsync(data, {
            abortEarly: false
          });
        case 2:
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _mongodb2.getDB)().collection(contentCollectionName)
...
// Phuong: Tìm dựa trên id của content.
var findOneByContentId = /*#__PURE__*/function () {
  ...
  return function findOneByContentId(_x3) {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.next = 6;
          return (0, _mongodb2.getDB)().collection(contentCollectionName).insertOne(validatedValue);
        case 6:
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return (0, _mongodb2.getDB)().collection(contentCollectionName).findOneAndUpdate(
...
var updateByContentId = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(content_id, data) {
    var updateData, result;
  ...
  return function updateByContentId(_x7, _x8) {
    return _ref6.apply(this, arguments);
  };
}();
var ContentModel = {
  contentCollectionName: contentCollectionName,
  createNew: createNew,
  updateById: updateById,
  updateByContentId: updateByContentId,
  findOneByContentId: findOneByContentId,
