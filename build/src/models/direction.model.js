...
var directionCollectionName = 'directions';
var directionCollectionSchema = _joi["default"].object({
  transport: _joi["default"].string()["default"](null),
  geocoded_waypoints: _joi["default"].array()["default"](null),
  data: _joi["default"].object()["default"](null),
  callFrom: _joi["default"].string()["default"]('GCP'),
  ...
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(data) {
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return directionCollectionSchema.validateAsync(data, {
            abortEarly: false
          });
        case 2:
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _mongodb2.getDB)().collection(directionCollectionName)
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return (0, _mongodb2.getDB)().collection(directionCollectionName).find({
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.next = 6;
          return (0, _mongodb2.getDB)().collection(directionCollectionName).insertOne(validatedValue);
        case 6:
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return (0, _mongodb2.getDB)().collection(directionCollectionName).findOneAndUpdate(
...
var DirectionModel = {
  directionCollectionName: directionCollectionName,
  createNew: createNew,
  update: update,
  findOneById: findOneById,
  findOriDesPlaceId: findOriDesPlaceId
};
exports.DirectionModel = DirectionModel;