...
var reviewsCollectionName = 'reviews';
var reviewsCollectionSchema = _joi["default"].object({
  place_reviews_id: _joi["default"].string()["default"](null),
  reviews: _joi["default"].array()["default"]([]),
...
var INVALID_UPDATE_FILEDS = ['_id', 'place_reviews_id', 'createdAt'];
  ...
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(data) {
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return reviewsCollectionSchema.validateAsync(data, {
            abortEarly: false
          });
        case 2:
...
// Phuong: Tìm dựa trên id của reviews.
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _mongodb2.getDB)().collection(reviewsCollectionName)
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          _context3.next = 6;
          return (0, _mongodb2.getDB)().collection(reviewsCollectionName).insertOne(validatedValue);
        case 6:
...
// Phuong: Cập nhật reviews thông qua _id
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 5;
          return (0, _mongodb2.getDB)().collection(reviewsCollectionName).findOneAndUpdate(
...
var ReviewsModel = {
  reviewsCollectionName: reviewsCollectionName,
  createNew: createNew,
  update: update,
